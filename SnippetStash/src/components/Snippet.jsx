...
const Snippet = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-gray-900 text-gray-200 py-4 sm:py-6 px-3 sm:px-4">
      <div className="w-full max-w-7xl mx-auto">
        <div className="mb-4 sm:mb-6">
          <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-1 sm:mb-2">Your Snippets</h1>
          <p className="text-sm sm:text-base text-gray-400 mb-3 sm:mb-4 md:mb-6">Manage and search your code snippets</p>
        ...
        {filteredData.length === 0 ? (
          <div className="bg-gray-800 rounded-lg p-4 sm:p-8 text-center">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-12 sm:h-16 w-12 sm:w-16 mx-auto text-gray-600 mb-3 sm:mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6">
            {filteredData.map((snippet) => {
              ...
              return (
                <div 
                  key={snippet._id} 
                  className="bg-gray-800 rounded-lg sm:rounded-xl shadow-lg overflow-hidden border border-gray-700 hover:border-purple-500 transition-all h-full flex flex-col"
                >
                  <div className="p-2 sm:p-3 md:p-5 flex-grow flex flex-col">
                    <h2 className="text-base sm:text-lg md:text-xl font-bold text-white mb-1 sm:mb-2 line-clamp-1">{snippet.title}</h2>
                    
                    <div className="bg-gray-700 rounded-md sm:rounded-lg p-2 sm:p-3 md:p-4 mb-2 sm:mb-3 md:mb-4 overflow-x-auto flex-grow">
                    ...
                    <div className="flex flex-col space-y-2 sm:space-y-0 sm:flex-row sm:items-center justify-between mt-auto">
                      <div className="flex items-center text-gray-500 text-xs">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                        <span className="text-tiny sm:text-xs truncate max-w-[110px] sm:max-w-full">{formatDate(snippet.createdAt)}</span>
                      </div>
                      
                      <div className="flex space-x-1 justify-end">
                        <Link 
                          to={`/?snippetId=${snippet._id}`}
                          className="p-1 bg-black text-gray-400 hover:text-white hover:bg-gray-700 rounded transition-all"
                          title="Edit"
                        >
                        ...
                        <button
                          ...
                          className="p-1 bg-black text-gray-400 hover:text-red-500 hover:bg-gray-700 rounded transition-all"
                          title="Delete"
                        >
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5 sm:h-4 sm:w-4 md:h-5 md:w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {showShareModal && activeSnippetId && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
          <div className="bg-gray-800 p-4 sm:p-6 rounded-xl shadow-xl max-w-md w-full border border-gray-700">
            <h3 className="text-lg sm:text-xl font-bold text-white mb-3 sm:mb-4 text-center">Share Snippet</h3>
            ...
            <div className="text-center">
              <button
                ...
                className="px-4 sm:px-5 py-2 bg-purple-600 text-white font-medium rounded-lg hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-50 transition-all shadow-lg"
              >
                Close
              </button>
            </div>
